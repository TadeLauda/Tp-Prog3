// Importaciones
import { getOneProduct, getProductInCategory } from "../services/product.js"
...
const product_responsable= document.getElementById("product-responsable")
              ...
              <div class="card h-100">
                ...
                <div class="card-boody p-4">
                  <div class="text-center">
                    ...
                    <span>${product.tiempo} restantes</span>
                  </div>
                </div>
...
const fillDetailProduct = async() =>{
    ...
    if(product){
        ...
        product_time.innerText= `${product.tiempo}`
